class HeaderGR:
    ...
    footer = "© Μίχος Ευάγγελος - Μεταπτυχιακή Εργασία - Αστυνομική Πλατφόρμα Παρακολούθησης σε Πραγματικό Χρόνο"
...
class SignupGR:
    ...
    reset = "Καθαρισμός"
    returnhome = "Επιστροφή στην Αρχική"
    returnlogin = "Συνδεθείτε στο λογαριασμό σας"

class ManageGR:
    panel = "Διαχείριση Ιστοσελίδας"
    insert = "Εισαγωγή"
    editcriminals = "Επεξεργασία Κακοποιών"
    editinfo = "Πατώντας το παραπάνω κουμπί, μπορείτε να :"
    insertcriminals = "Εισάγετε νέους κακοποιούς"
    updatecriminals = "Επεξεργαστείτε τους υπάρχοντες κακοποιούς"
    removecriminals = "Αφαιρέσετε ανεπιθύμητους κακοποιούς"
    editusers = "Επεξεργασία Χρηστών"
    insertusers = "Εισάγετε νέους χρήστες"
    updateusers = "Επεξεργαστείτε τους υπάρχοντες χρήστες"
    removeusers = "Αφαιρέσετε ανεπιθύμητους χρήστες"
...
class InsertCriminalsGR:
    ...
    lastlocation = "Τελευταία θέση (προεραιτικό)"
